            ...
            $this->sections[] = array(
                ...
                'fields' => array(
                    ...
                    array(
                        ...
                        'multi' => false,
                        'width' => '100%',
                        'args' => array('taxonomies'=>'coupon_store', 'args'=>array()),
            ...
            $this->sections[] = array(
                ...
                'fields' => array(
                    ...
                    array(
                        ...
                        'type'     => 'text',
                        'default' => '15',
                        'title'    => esc_html__('Number active coupons to show', 'wp-coupon'),
                    ),

                    array(
                        'id'       =>'store_number_unpopular',
                        'type'     => 'text',
                        'default' => '10',
                        'title'    => esc_html__('Number unpopular coupons to show', 'wp-coupon'),
                    ),

                    array(
                        'id'       =>'store_number_expires',
                        'type'     => 'text',
                        'default' => '5',
                        'title'    => esc_html__('Number expires coupons to show', 'wp-coupon'),
                    ),
