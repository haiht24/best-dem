    ...
    <div class="coupon-detail coupon-button-type">
        ...
        <div class="exp-text">
            <?php if ( ! wpcoupon_coupon()->has_expired() ) { ?>
                <?php printf( esc_html__( 'Expires %s', 'wp-coupon' ), wpcoupon_coupon()->get_expires() ); ?>
            <?php } else { ?>
                <?php echo wpcoupon_coupon()->get_expires() ; ?>
            <?php } ?>
            <a data-position="top center" data-inverted=""  data-tooltip="<?php esc_attr_e( "Save this coupon", 'wp-coupon' ); ?>" href="#" data-coupon-id="<?php echo wpcoupon_coupon()->ID; ?>" class="add-coupon-favorite coupon-save icon-popup"><i class="empty star icon"></i></a>
        </div>
