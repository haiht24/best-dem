...
<div class="coupon-footer coupon-listing-footer">
    <ul class="clearfix">
        ...
        <li><a title="<?php esc_attr_e( 'Coupon Comments', 'wp-coupon' ); ?>" data-reveal="reveal-comments" href="#"><i class="comments outline icon"></i> <?php esc_html_e( 'Comments', 'wp-coupon' ) ?></a></li>
    </ul>
