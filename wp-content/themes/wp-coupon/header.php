                ...
                <div class="logo_area fleft">
                    <?php if ( wpcoupon_get_option('site_logo', false, 'url') != '' ) { ?>
                        <a href="<?php echo esc_url( home_url( '/' ) ); ?>" title="<?php echo esc_attr( get_bloginfo( 'name', 'display' ) ); ?>" rel="home">
                            <img src="<?php echo wpcoupon_get_option('site_logo', false, 'url'); ?>" alt="<?php echo get_bloginfo( 'name' ) ?>" title="<?php echo get_bloginfo( 'name' ) ?>" />
                        </a>
                    <?php } else { ?>
                ...
                <div class="header_right fright">
                    <form action="<?php echo home_url( '/' ); ?>" method="get" id="header-search">
                        <div class="header-search-input ui search large action left icon input">
                            <input autocomplete="off" class="prompt" name="s" placeholder="<?php esc_attr_e( 'Search...', 'wp-coupon' ); ?>" type="text">
                        ...
                        if ( ! empty( $store_ids ) ) {
                            ...
                            if ( $stores ) {
                                ...
                                foreach ( $stores as $store ){
                                    $links[] = '<a href="'.get_term_link( $store, 'coupon_store' ).'" title="'.esc_html( $store->name ).'">'.esc_html( $store->name ).'</a>';
                                }
        ...
        <div id="site-header-nav" class="site-navigation">
            <div class="container">
                <nav class="primary-navigation clearfix fleft" role="navigation">
                    <a href="#content" class="screen-reader-text skip-link" title="<?php esc_html_e( 'Skip to content', 'wp-coupon' ); ?>"><?php esc_html_e( 'Skip to content', 'wp-coupon' ); ?></a>
                ...
                <?php
                if(in_array(wpcoupon_store()->taxonomy, ['coupon_store', 'coupon_tag', 'coupon_category'])) :
